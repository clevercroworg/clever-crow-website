      ...
      <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4.5 w-full sm:w-auto mb-10 items-center justify-center">
          <a 
            ...
            className="glow-btn bg-brand-accent text-brand-dark hover:bg-white font-heading text-lg md:text-xl font-bold px-10 py-4 rounded-full flex items-center justify-center gap-3 transition-all duration-300 cursor-pointer tracking-[0.08em] shadow-lg shadow-brand-accent/15 w-full sm:w-auto font-bold-important"
          >
          ...
          <a 
            ...
            className="border border-white/20 hover:border-brand-accent text-white hover:text-brand-accent font-heading text-lg md:text-xl font-bold px-10 py-4 rounded-full flex items-center justify-center gap-3 transition-all duration-300 tracking-[0.08em] w-full sm:w-auto font-bold-important"
          >
            <svg 
              viewBox="0 0 24 24" 
            ...
            <span className="font-bold-important">Talk on WhatsApp</span>
          </a>
        </div>
