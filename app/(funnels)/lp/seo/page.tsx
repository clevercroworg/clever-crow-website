...
import { 
  Phone, Award, Users, Headphones, Search, Sparkles, 
  CheckCircle, ShieldCheck, User, Send, ArrowRight, X, 
  GraduationCap, ChevronDown, Rocket, Flame, TrendingUp
} from 'lucide-react';
...
export default function SeoLandingPage() {
  ...
  const whatsappUrl = "https://wa.me/919986389444?text=Hi%20Clever%20Crow%2C%20I%27m%20interested%20in%20SEO%20services.%20(Ref:%20LP/SEO)";
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitLead(formData.name, formData.phone, "SEO Landing Page");
  ...
  const handleModalFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitLead(modalFormData.name, modalFormData.phone, "SEO Landing Page (Modal)");
      // Fire Google conversion tracking
      if (typeof window !== 'undefined' && (window as any).gtag) {
        (window as any).gtag('event', 'conversion', {
          'send_to': 'AW-17335403082/YwV4CJ-q_e8YEPq9me49',
  ...
  const pricingPlans = [
    {
      ...
      description: "Ideal for local businesses or small websites aiming for steady organic growth.",
      price: "₹12,000",
      period: "/ month",
      icon: Rocket,
      features: [
        ...
        "Website audit and SEO health check",
        "Monthly keyword tracking report",
        "Basic blog optimization",
        "Email and chat support"
      ],
      image: "/lp/digital-marketing/images/seobg.jpg"
    },
    {
      title: "Expansion Package",
      description: "Ideal for multi-city businesses ready to expand visibility and outrank competition.",
      price: "₹18,000",
      period: "/ month",
      icon: Flame,
      features: [
        ...
        "Schema implementation and image optimization",
        "Monthly strategy review call",
        "Email and call support"
      ],
      image: "/lp/digital-marketing/images/googleadsbg.jpg"
    },
    {
      title: "Enterprise Package",
      description: "Ideal for nationwide or eCommerce brands seeking advanced growth and dominance.",
      price: "₹25,000",
      period: "/ month",
      icon: TrendingUp,
      features: [
        ...
        "Core Web Vitals and speed enhancement",
        "Dedicated SEO manager",
        "Priority support"
      ],
      image: "/lp/digital-marketing/images/webbg.jpg"
    }
  ];
  ...
  const processSteps = [
    { step: "Step 01", title: "Understanding Business Goals", desc: "We align SEO strategy with your products, market, audience, and revenue goals." },
    { step: "Step 02", title: "Comprehensive Keyword Research", desc: "We identify intent-driven keywords that balance volume, relevance, and conversion potential." },
    { step: "Step 03", title: "Identifying High-Value Opportunities", desc: "We prioritize pages and topics that can deliver the highest impact in the shortest time." },
    { step: "Step 04", title: "Improving Search Visibility", desc: "Execution includes technical fixes, on-page improvements, and authority building." }
  ];
  ...
  return (
    <div className="bg-slate-50 pb-24 text-slate-800 hospitality-funnel">
      ...
      {/* Hero Section */}
      <section className="hero-bg-seo pt-8 pb-16 text-white sm:py-20">
        <div className="hero-grid-pattern" aria-hidden="true" />
        <span className="hero-orb hero-orb-green-1"></span>
        <span className="hero-orb hero-orb-green-2"></span>
        <span className="hero-orb hero-orb-green-3"></span>
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-12 lg:px-8">
          <div className="lg:col-span-8">
            ...
            <p className="mt-4 max-w-2xl text-base text-slate-200 sm:text-lg leading-relaxed">Technical, on-page, and off-page SEO strategies built to grow organic traffic, qualified leads, and long-term ROI.</p>
            ...
            <div className="mt-8 grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="group rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/[0.08] hover:border-white/20 hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center shadow-lg backdrop-blur-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-400 mb-3 shadow-inner group-hover:scale-110 transition-transform duration-300">
                  <Award className="w-6 h-6" />
                </div>
                <p className="text-xs md:text-sm font-bold text-white leading-snug">15+ Years of SEO Experience</p>
              </div>
              <div className="group rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/[0.08] hover:border-white/20 hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center shadow-lg backdrop-blur-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-400 mb-3 shadow-inner group-hover:scale-110 transition-transform duration-300">
                  <GraduationCap className="w-6 h-6" />
                </div>
                <p className="text-xs md:text-sm font-bold text-white leading-snug">Technical + Content SEO Experts</p>
              </div>
              <div className="group rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/[0.08] hover:border-white/20 hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center shadow-lg backdrop-blur-sm">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-400 mb-3 shadow-inner group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="group rounded-2xl border border-white/10 bg-white/5 p-5 hover:bg-white/[0.08] hover:border-white/20 hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center shadow-lg backdrop-blur-sm">
                ...
                <p className="text-xs md:text-sm font-bold text-white leading-snug">Transparent Monthly Reporting</p>
              </div>
            </div>
          </div>
      ...
      <section id="pricing" className="section-grid py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold sm:text-4xl text-slate-900">SEO Plans & Deliverables</h2>
            <p className="mx-auto mt-3 max-w-2xl text-slate-600">Choose the right SEO growth plan based on your business stage, target market, and organic growth goals.</p>
          </div>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {pricingPlans.map((plan, index) => {
              ...
              return (
                <article key={index} className={`group relative overflow-hidden rounded-3xl border bg-white shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ${plan.title === 'Expansion Package' ? 'border-emerald-500 ring-2 ring-emerald-500/20' : 'border-slate-200'}`}>
                  {plan.title === 'Expansion Package' && (
                    <div className="absolute top-4 right-4 z-10 rounded-full bg-emerald-500 px-3 py-1 text-[10px] font-extrabold uppercase tracking-wider text-white shadow-sm">Most Popular</div>
                  )}
                  ...
                  <div className="p-6">
                    <h3 className="inline-flex items-center gap-2 text-lg font-black uppercase tracking-[0.06em] text-slate-900">
                      <IconComp className="w-5 h-5 text-emerald-500 shrink-0 group-hover:scale-110 transition-transform duration-300" />
                      {plan.title}
                    </h3>
                    ...
                    <div className="mt-5 rounded-2xl border border-emerald-500/60 bg-emerald-50/30 p-4">
          ...
          <div className="mt-12 rounded-3xl border border-emerald-200 bg-emerald-50/30 p-8 text-center backdrop-blur-sm">
            <p className="text-lg text-slate-700 font-medium flex items-center justify-center gap-2 flex-wrap">
              ...
              Need custom SEO deliverables beyond these plans? We can build a tailored roadmap for your business goals.
            </p>
            <button 
            ...
            <p className="mt-4 text-xs text-slate-500">Pricing covers SEO service fees only. Paid tools, content writing, and third-party backlink placements are billed separately as required.</p>
            <p className="mt-2 text-xs text-slate-500">Add-on: Content writing or extra backlinks at ₹3,000-₹5,000 per month.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold sm:text-4xl text-slate-900">Our SEO Process</h2>
            <p className="mx-auto mt-3 max-w-2xl text-slate-600">A structured process designed to improve rankings, traffic quality, and organic lead flow.</p>
          </div>

          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {processSteps.map((step, index) => (
              <article key={index} className="rounded-2xl border border-slate-200 bg-slate-50 p-6 shadow-sm hover:border-emerald-300 hover:shadow-md transition-all duration-300">
                <p className="text-xs font-bold uppercase tracking-[0.14em] text-emerald-600">{step.step}</p>
            ...
            <div className="grid items-start gap-8 lg:grid-cols-12">
              ...
              <div className="lg:col-span-4">
                ...
                <div className="mt-3 space-y-3">
                  <div className="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm hover:-translate-y-0.5 hover:border-emerald-400/40 hover:shadow transition-all duration-300">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full rounded-xl border border-slate-300 pl-11 pr-4 py-3 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100 transition" 
                  />
                </div>
              </div>
              <div>
