...
export default function DigitalMarketingLandingPage() {
  ...
  const pricingPlans = [
    {
      ...
      description: "Professional business website focused on trust and enquiries.",
      price: "₹9,999",
      period: "/ project",
      icon: Monitor,
      features: [
        ...
        "WhatsApp and call CTA integration",
    ...
    },
    {
      ...
      description: "Boost search visibility and get steady organic leads.",
      price: "₹12,000",
      period: "/ month",
      icon: Search,
      features: [
        ...
        "Content gap and topic mapping"
      ],
      image: "/lp/digital-marketing/images/seobg.jpg"
    },
    {
      title: "Google Ads Management",
      description: "Run high-intent campaigns that bring qualified enquiries.",
      price: "₹15,000",
      period: "/ month",
      icon: FaGoogle,
      features: [
        ...
        "Landing page quality improvement notes"
      ],
      image: "/lp/digital-marketing/images/googleadsbg.jpg"
    },
    {
      title: "Meta Ads",
      description: "Generate leads from Facebook and Instagram campaigns.",
      price: "₹15,000",
      period: "/ month",
      icon: FaInstagram,
      features: [
        ...
        "Retargeting setup",
        "Monthly ROI reports",
        "Lead form campaign optimization",
    ...
    {
      title: "AI Automation",
      description: "Automate lead follow-ups and sales workflows efficiently.",
      price: "₹15,000",
      period: "/ setup",
      icon: Sparkles,
      features: [
    ...
    },
    {
      ...
      description: "Build a strong brand presence with consistent social content.",
      price: "₹12,000",
      period: "/ month",
      icon: Megaphone,
      features: [
        "Content planning and creatives",
        "Post scheduling and publishing",
        "Monthly insight reports",
        "Reel and short-video content plan",
  ...
  return (
    <div className="bg-slate-50 pb-24 text-slate-800 hospitality-funnel">
      ...
      <section id="pricing" className="section-grid py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-extrabold sm:text-4xl text-slate-900">Smart Plans, Tailored for Business Growth</h2>
            <p className="mx-auto mt-3 max-w-2xl text-slate-600">Solutions designed to drive real growth.</p>
          </div>
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {pricingPlans.map((plan, index) => {
              ...
              return (
                <article key={index} className={`group relative overflow-hidden rounded-3xl border bg-white shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 ${plan.title === 'Google Ads Management' ? 'border-amber-400 ring-2 ring-amber-400/20' : 'border-slate-200'}`}>
                  {plan.title === 'Google Ads Management' && (
                    <div className="absolute top-4 right-4 z-10 rounded-full bg-amber-400 px-3 py-1 text-[10px] font-extrabold uppercase tracking-wider text-slate-900 shadow-sm">Most Popular</div>
                  )}
                  ...
                  <div className="p-6">
                    <h3 className="inline-flex items-center gap-2 text-lg font-black uppercase tracking-[0.06em] text-slate-900">
                      <IconComp className="w-5 h-5 text-amber-500 shrink-0 group-hover:scale-110 transition-transform duration-300" />
                      {plan.title}
                    </h3>
                    <p className="mt-2 text-sm text-slate-600 min-h-[40px]">{plan.description}</p>
                    <ul className="mt-4 space-y-2 text-sm text-slate-700 min-h-[140px]">
                    ...
                    <div className="mt-5 rounded-2xl border border-[#FFCE1B]/60 bg-[#fff9e3] p-4">
          ...
          <div className="mt-12 rounded-3xl border border-amber-200 bg-amber-50/50 p-8 text-center backdrop-blur-sm">
            ...
            <div className="grid items-start gap-8 lg:grid-cols-12">
              ...
              <div className="lg:col-span-4">
                ...
                <div className="mt-3 space-y-3">
                  <div className="rounded-2xl border border-slate-200 bg-white p-3 shadow-sm hover:-translate-y-0.5 hover:border-amber-400/40 hover:shadow transition-all duration-300">
      ...
      {/* Reels Section — Improvement #2: Lazy-load, show 10 initially */}
          ...
          <div className="mt-8 grid gap-4 grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
            {(showAllReels ? reels : reels.slice(0, 10)).map((src, i) => (
              <video 
                ...
                ref={reelCallback}
                data-src={src}
                className="w-full rounded-2xl shadow-sm aspect-[9/16] object-cover bg-black border border-slate-200 hover:scale-[1.02] hover:border-amber-400/40 transition-all duration-300 cursor-pointer" 
                muted 
                loop 
                playsInline
                preload="none"
      ...
      {/* Client Stats Grid — Improvement #3: CountUp animation */}
      ...
      {/* Success Testimonial Cards — Improvement #4: Google icon + left border */}
      ...
      {/* Footer */}
      {/* Footer — Improvement #7: Gradient bg + logo */}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full rounded-xl border border-slate-300 pl-11 pr-4 py-3 text-sm outline-none focus:border-amber-500 focus:ring-2 focus:ring-amber-100 transition" 
                  />
                </div>
              </div>
              <div>
