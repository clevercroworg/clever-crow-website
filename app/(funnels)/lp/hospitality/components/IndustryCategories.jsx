  ...
  return (
    <section id="who-we-help" className="py-24 px-6 bg-brand-dark overflow-hidden border-t border-brand-border/40">
      ...
      <div className="max-w-7xl mx-auto mb-16 text-center">
        ...
        <p className="font-body text-xs md:text-sm text-brand-textSecondary max-w-xl mx-auto mt-3">
          Growth systems for premium hospitality and experience-led brands.
        </p>
      </div>
      
      {/* Directory Rows */}
      <div className="w-full max-w-[1500px] mx-auto border-t border-white/10 flex flex-col group/container">
          ...
          >
            <div className="flex flex-col md:grid md:grid-cols-[120px_280px_1fr] lg:grid-cols-[140px_320px_1fr] items-start md:items-center p-6 md:py-10 md:px-8 gap-4 md:gap-0 relative">
              ...
              <div className="flex flex-col gap-1 pr-4">
                <h4 className="font-heading text-[20px] md:text-[24px] font-bold text-brand-accent uppercase tracking-wide transition-colors duration-300 leading-none font-bold-important">
                  {item.title}
                </h4>
                <span className="font-body text-[10px] font-bold uppercase text-white/70 tracking-[0.15em] group-hover/row:text-brand-accent transition-colors duration-300 mt-1">
                  {item.tagline}
                </span>
              </div>
